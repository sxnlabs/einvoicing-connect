...
Gem::Specification.new do |s|
  ...
  s.summary     = "Platform connectors for the einvoicing gem — PPF/Chorus Pro, SIRET lookup"
  s.description = "Adds French PPF/Chorus Pro invoice submission and SIRET lookup to the einvoicing gem."
